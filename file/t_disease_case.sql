CREATE TABLE `t_disease_case` (
  ...
  `depart_id` bigint(20) NOT NULL COMMENT '收集单位ID',
  `depart_name` varchar(200) NOT NULL COMMENT '收集单位名称',
  `name` varchar(50)  NOT NULL COMMENT '姓名',
  `age` int(10) NOT NULL COMMENT '年龄',
  `sex` int(4) DEFAULT '0' COMMENT '性别[0:男;1:女]',
  `is_married` int(4) DEFAULT '0' COMMENT '婚姻[0:否;1:是]',
  `profession` varchar(200) NOT NULL COMMENT '职业',
  `birth_address` varchar(200) NOT NULL COMMENT '出生地',
  ...
  `contact_address` varchar(200) NOT NULL COMMENT '通讯地址',
  `contact_name` varchar(50) DEFAULT '' COMMENT '联系人',
  `contact_phone` varchar(50) DEFAULT '' COMMENT '联系电话',
  `in_hospital_date` timestamp NOT NULL COMMENT '入院日期',
  `out_hospital_date` timestamp NOT NULL COMMENT '出院日期',
  `in_hospital_office` varchar(200) NOT NULL COMMENT '入院科室',
  `out_hospital_office` varchar(200) NOT NULL COMMENT '出院科室',
  `hospital_days` int(10) NOT NULL COMMENT '住院天数',

  #疾病诊断
  `in_diagnose` varchar(500) NOT NULL COMMENT '入院诊断',
  `out_diagnose` varchar(500) NOT NULL COMMENT '出院主要诊断',
  ...
  #病史
  `medical_history` varchar(500) NOT NULL COMMENT '主诉',
  `medical_history1` varchar(200) NOT NULL COMMENT '现病史',
  ...
  #体格检查
  `physical_examine1` varchar(50) NOT NULL COMMENT 'T',
  `physical_examine2` varchar(50) NOT NULL COMMENT 'P',
  `physical_examine3` varchar(50) NOT NULL COMMENT 'R',
  `physical_examine4` varchar(50) NOT NULL COMMENT 'SBP',
  `physical_examine5` varchar(50) NOT NULL COMMENT 'DBP',
  `physical_examine6` varchar(50) NOT NULL COMMENT '身高',
  `physical_examine7` varchar(50) NOT NULL COMMENT '体重',
  `physical_examine8` varchar(50) DEFAULT NULL COMMENT '腹围',
  `physical_examine9` varchar(500) DEFAULT '' COMMENT '体格检查',

  #实验室检查
  `blood_routine1` varchar(50) NOT NULL COMMENT '红细胞计数(RBC)',
  `blood_routine2` varchar(50) NOT NULL COMMENT '红细胞压积(HCT)',
  `blood_routine3` varchar(50) NOT NULL COMMENT '平均红细胞体积(MCV)',
  `blood_routine4` varchar(50) NOT NULL COMMENT '红细胞分布宽度',
  `blood_routine5` varchar(50) NOT NULL COMMENT '血红蛋白浓度(HGB)',
  `blood_routine6` varchar(50) NOT NULL COMMENT '白细胞计数(WBC)',
  `blood_routine7` varchar(50) NOT NULL COMMENT '单核细胞计数(MONO) ',
  `blood_routine8` varchar(50) NOT NULL COMMENT '单核细胞比例(MONO%)',
  `blood_routine9` varchar(50) NOT NULL COMMENT '中性粒细胞计数(NEUT)',
  `blood_routine10` varchar(50) NOT NULL COMMENT '中性粒细胞比例(NEUT%) ',
  `blood_routine11` varchar(50) NOT NULL COMMENT '淋巴细胞计数(LY) ',
  `blood_routine12` varchar(50) NOT NULL COMMENT '淋巴细胞比值(LY%)',
  `blood_routine13` varchar(50) NOT NULL COMMENT '血小板计数(PLT)',
  `blood_routine14` varchar(50) NOT NULL COMMENT '血小板体积分布宽度(PDW) ',
  `blood_routine15` varchar(50) NOT NULL COMMENT '平均血小板体积(MPV) ',
  `blood_routine16` varchar(50) NOT NULL COMMENT '血清丙氨酸氨基转移酶（ALT）',
  `blood_routine17` varchar(50) NOT NULL COMMENT '血清天门冬氨酰基转移酶（AST）',
  `blood_routine18` varchar(50) NOT NULL COMMENT '碱性磷酸酶（ALP）',
  `blood_routine19` varchar(50) NOT NULL COMMENT '血清γ--谷氨酰基转移酶（GGT）',
  `blood_routine20` varchar(50) NOT NULL COMMENT '血清总蛋白测定',
  `blood_routine21` varchar(50) NOT NULL COMMENT '血清白蛋白测定',
  `blood_routine22` varchar(50) NOT NULL COMMENT '球蛋白',
  `blood_routine23` varchar(50) NOT NULL COMMENT '血清总胆红素测定',
  `blood_routine24` varchar(50) NOT NULL COMMENT '血清直接胆红素',
  `blood_routine25` varchar(50) NOT NULL COMMENT '血清总胆固醇',
  `blood_routine26` varchar(50) NOT NULL COMMENT '血清甘油三酯',
  `blood_routine27` varchar(50) NOT NULL COMMENT '血清高密度脂蛋白胆固醇',
  `blood_routine28` varchar(50) NOT NULL COMMENT '血清低密度脂蛋白胆固醇',
  ...
  `blood_routine32` varchar(50) NOT NULL COMMENT '尿素',
  `blood_routine33` varchar(50) NOT NULL COMMENT '肌酐',
  ...
  `blood_routine40` varchar(50) NOT NULL COMMENT '钾（K）',
  `blood_routine41` varchar(50) NOT NULL COMMENT '钠（Na）',
  `blood_routine42` varchar(50) NOT NULL COMMENT '氯（Cl）',
  `blood_routine43` varchar(50) NOT NULL COMMENT '钙（Ca）',
  `blood_routine44` varchar(50) DEFAULT '' COMMENT '磷（P）',
  `blood_routine45` varchar(50) NOT NULL COMMENT '随机血糖',
  ...
  #特殊检查
  `special_examine1` varchar(200) NOT NULL COMMENT '心电图[图片]',
  `special_examine2` varchar(200) NOT NULL COMMENT '心脏超声[图片]',
