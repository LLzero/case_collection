      ...
      <div id="tab1" class="tab-pane fade in active">
        <div class="row">
          <div class="col-sm-6">
            ...
            <input type="text" id="departName"  name="departName" value="${diseaseCase.departName}" />
            <font color="red">*</font>
          </div>
          <div class="col-sm-6">
      ...
      <div id="tab4" class="tab-pane fade in ">
        ...
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <input type="text" id="bloodRoutine6" name="bloodRoutine2" value="${diseaseCase.bloodRoutine2}" />X10^9/L
            <font color="red">*</font>
          </div>
        </div>
        <div class="row">
      ...
      <div id="tab6" class="tab-pane fade in">
        ...
        <div class="row">
          <div class="col-sm-12">
            ...
            <label>
              <input type="checkbox"  key="treatment1" value="1" class="ace" />
              <span class="lbl"> 阿司匹林</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment2" value="1" class="ace" />
              <span class="lbl"> 氯吡格雷</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment3" value="1" class="ace" />
              <span class="lbl"> 替格瑞洛</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment4" value="1" class="ace" />
              <span class="lbl"> ACEI</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment5" value="1" class="ace" />
              <span class="lbl"> ARB</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment6" value="1" class="ace" />
              <span class="lbl"> 钙离子拮抗剂</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment7" value="1" class="ace" />
              <span class="lbl"> 依法布雷定</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment8" value="1" class="ace" />
              <span class="lbl"> B受体阻滞剂</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment9" value="1" class="ace" />
              <span class="lbl"> B受体阻滞剂</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment10" value="1" class="ace" />
              <span class="lbl"> 醛固酮拮抗剂</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment11" value="1" class="ace" />
              <span class="lbl"> 硝酸甘油或硝酸酯类药物</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment12" value="1" class="ace" />
              <span class="lbl"> 袢利尿剂</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment13" value="1" class="ace" />
              <span class="lbl"> 双氢克尿噻</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment14" value="1" class="ace" />
              <span class="lbl"> 二甲双胍类</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment15" value="1" class="ace" />
              <span class="lbl"> α-葡萄糖苷酶(阿卡波糖、伏格列波糖)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment16" value="1" class="ace" />
              <span class="lbl"> 胰岛素及其类似物</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment17" value="1" class="ace" />
              <span class="lbl"> 磺脲类促泌剂(格列吡嗪、格列齐特、格列本脲、格列波脲、格列美脲)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment18" value="1" class="ace" />
              <span class="lbl"> 非磺脲类苯茴酸类衍生物促泌剂(瑞格列奈)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment19" value="1" class="ace" />
              <span class="lbl"> 胰岛素增敏剂(罗格列酮、吡格列酮)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment20" value="1" class="ace" />
              <span class="lbl"> GLP-1受体激动剂(利拉鲁肽、艾塞那肽)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment21" value="1" class="ace" />
              <span class="lbl"> DPP-4抑制剂(西格列汀、沙格列汀</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment22" value="1" class="ace" />
              <span class="lbl"> HMG—CoA还原酶抑制剂(他汀)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment23" value="1" class="ace" />
              <span class="lbl"> 烟酸及其衍生物</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment24" value="1" class="ace" />
              <span class="lbl"> 贝特类(非诺贝特、利贝特、苯扎贝特、吉非贝齐、氯贝特)</span>
            </label>
            <label>
              <input type="checkbox"  key="treatment25" value="1" class="ace" />
